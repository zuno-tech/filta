---
name: upgrade-ruby
description: 'Update Ruby version in the filta gem repo. Run after /upgrade-ruby-setup has checked out main and created the upgrade branch. Updates .ruby-version and the GitHub Actions CI matrix.'
...
- `Gemfile` — no Ruby pin
- `filta.gemspec` — floor constraint only
